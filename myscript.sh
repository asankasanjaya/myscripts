...
function puppet_stratos_setup() {
  ...
  sudo cp -f $STRATOS_SOURCE_PATH/products/python-cartridge-agent/distribution/target/apache-stratos-python-cartridge-agent-4.1.0.zip /etc/puppet/modules/python_agent/files
